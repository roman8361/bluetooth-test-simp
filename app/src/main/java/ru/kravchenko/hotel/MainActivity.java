...
public class MainActivity extends AppCompatActivity implements CompoundButton.OnCheckedChangeListener,
    ...
    public static final String ONES_DATA = "St#31nH5c23t!";
    public static final String TWOS_DATA = "2222";
    public static final String ONE_DATA = "1";
    public static final String TWO_DATA = "2";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        onesButton = findViewById(R.id.ones);
        twosButton = findViewById(R.id.twos);
        ...
        onesButton.setOnClickListener(this);
    ...
    public void onClick(View v) {
        if (v.equals(btnEnableSearch)) {
            ...
            showFrameControls();
        } else if (v.equals(onesButton)) {
            enableLed(ONES_DATA);
        } else if (v.equals(twosButton)) {
            enableLed(TWOS_DATA);
        } else if (v.equals(oneButton)) {
            enableLed(ONE_DATA);
        } else if (v.equals(twoButton)) {
            enableLed(TWO_DATA);
        }
    }
    ...
    private void setListAdapter(int type) {
        ...
        switch (type) {
            case BT_BOUNDED:
                ...
                break;
            case BT_SEARCH:
                iconType = R.drawable.ic_bluetooth_searching_device;
                break;
        }
...
//    }
    ...
    private void enableLed(String led) {
        if (connectedThread != null && connectThread.isConnect()) {
            String  command = "";
            switch (led) {
                case ONES_DATA:
                    command = ONES_DATA;
                    Toast.makeText(MainActivity.this, "Send data: " + command, Toast.LENGTH_SHORT).show();
                    break;
                case TWOS_DATA:
                    command = TWOS_DATA;
                    Toast.makeText(MainActivity.this, "Send data: " + command, Toast.LENGTH_SHORT).show();
